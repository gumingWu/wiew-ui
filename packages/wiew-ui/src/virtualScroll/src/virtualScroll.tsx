import { defineComponent, ref, computed, reactive, unref, watch, onMounted, nextTick } from 'vue'
...
export default defineComponent({
  ...
  setup(props: VirtualScrollPropType, { slots }) {
    ...
    function getLast(first: number): number {
      ...
      const height = parseInt(props.height as string, 10) || wrapEl.clientHeight;
